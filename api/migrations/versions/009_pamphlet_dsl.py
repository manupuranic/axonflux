...
def upgrade():
    ...
    op.alter_column("pamphlets", "rows", nullable=True, schema="app", existing_type=sa.Integer())
    op.alter_column("pamphlets", "cols", nullable=True, schema="app", existing_type=sa.Integer())
...
def downgrade():
    ...
    op.alter_column("pamphlets", "rows", nullable=False, schema="app", existing_type=sa.Integer())
    op.alter_column("pamphlets", "cols", nullable=False, schema="app", existing_type=sa.Integer())
