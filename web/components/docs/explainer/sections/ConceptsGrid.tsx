...
const CONCEPTS: Concept[] = [
  ...
  },
  {
    ...
    definition: "Canvas dimensions live in the DSL root — not the renderer. Every layer derives its viewport from the document.",
    analogy: "Paper size belongs in print settings, not printer firmware.",
    here: "page.width_mm/height_mm in Campaign Studio DSL. HTML renderer, PDF exporter, preview iframe all read it. Adding WhatsApp Square or Instagram Story = one DSL field; no renderer code change.",
  ...
  },
  {
    ...
    definition: "Uploads land on disk; FastAPI StaticFiles serves them. URL structure mirrors a CDN — swap to production is two env vars.",
    analogy: "A sticky note on your desk — same content, no cloud account.",
    here: "/campaigns/{id}/assets/upload saves to disk. /uploads mount serves them. Frontend uses ${API_BASE}/uploads/… — same URL shape as R2/S3. Swap to real storage = two env vars, zero frontend code.",
