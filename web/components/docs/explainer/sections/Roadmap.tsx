...
const PHASES: {
...
}[] = [
  {
    ...
    items: [
      ...
      { name: "A5 · Campaign Studio", detail: "Multi-channel design tool for staff: pamphlets, WhatsApp posts, Instagram creatives, posters. 6-phase delivery — (1) 7-table schema + 29-endpoint CRUD/asset API, (2) 3-panel visual editor (Layers / Preview / Properties) with live DSL tree, (3) AI chat with DSL tool registry (apply_dsl_patch, set_theme, style_region, add_banner) + chat history + new-session, (4) PDF + PNG export via Playwright with format-correct viewport. Format-aware canvas: page.width_mm/height_mm drives HTML renderer, PDF exporter, preview iframe scale — A4, WhatsApp 1080×1080, Instagram Story 1080×1920 all supported. Image upload to local static serving (swap-ready for R2/S3). (6) QA shipped — 24 unit tests covering renderer formats, DSL tools, and upload sanitization. Phase 5 (Pamphlet Intelligence Agent, connects to D4) pending.", status: "in-flight" },
    ],
  },
  {
    key: "B",
